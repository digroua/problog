...
<footer class="footer-widget-section">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="address">
                        ...
                        <p> 4/8 BC Street, ES, VSA</p>

                        <p> Phone: +38 093 3733337</p>

                        <p>digroua@gmail.com</p>
                    </div>
                </aside>
            </div>
                ...
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        ...
                        <div>
                            ...
                            <span class="p-date">March 22, 2018</span>
                        </div>
                    </div>
                </aside>
            </div>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2018 <a href="#">Blog, </a> by <a href="#">DIGRO</a>
                    </div>
                </div>
            </div>
        </div>
